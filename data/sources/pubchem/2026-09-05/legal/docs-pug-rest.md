...
>>*   Kim S, Thiessen PA, Bolton EE. **Programmatic Retrieval of Small Molecule Information from PubChem Using PUG-REST**. In Kutchukian PS, ed. Chemical Biology Informatics and Modeling. Methods in Pharmacology and Toxicology. New York, NY: Humana Press, 2018, pp. 1-24. doi:10.1007/7653\_2018\_30.  
...
`compound domain <namespace> = cid | name | smiles | inchi | sdf | inchikey | formula | <structure search> | <xref> | <mass> | listkey | <fast search> | identifier`
...
`<other inputs> = sources / [substance, assay] | sourcetable | conformers | annotations/[sourcename/<source name> | heading/<heading>] | classification | standardize | periodictable | identifiertypes/<entity>`
...
| Property                 | Notes                                                                                                                                                                                                                                                                                               |
|--------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| MolecularFormula | Molecular formula in standard Hill notation element order, with total formal charge at the end. |
| MolecularFormulaNoCharge | Molecular formula, elements only, without total formal charge. |
...
| TPSA                     | [Topological polar surface area](/docs/glossary#section=TPSA), computed by the algorithm described in [the paper by Ertl et al](https://doi.org/10.1021/jm000942e).                                                                                                                                                       |
| Complexity               | The [molecular complexity](/docs/glossary#section=Complexity) rating of a compound, computed using the Bertz/Hendrickson/Ihlenfeldt formula.                                                                                                                                                                              |
...
This lists any third-party database identifiers available for given CIDs:

https://pubchem.ncbi.nlm.nih.gov/rest/pug/compound/cid/2244/identifiers/JSON

https://pubchem.ncbi.nlm.nih.gov/rest/pug/compound/cid/2244,180/identifiers/JSON?identifier_type=CAS
...
| SingleDoubleMatchAromatic or SingleDoubleBondsMatch | boolean | single or double bonds match aromatic bonds                          | true      |
...
Compounds can be input by identifiers from other database resources, for example:

https://pubchem.ncbi.nlm.nih.gov/rest/pug/compound/identifier/C00001/cids/JSON

https://pubchem.ncbi.nlm.nih.gov/rest/pug/compound/identifier/C00001/cids/JSON?identifier_type=any

https://pubchem.ncbi.nlm.nih.gov/rest/pug/compound/identifier/C00001/cids/JSON?identifier_type=KEGG+ID

A list of all available compound identifier types can be retrieved with:

https://pubchem.ncbi.nlm.nih.gov/rest/pug/IdentifierTypes/compound/TXT
