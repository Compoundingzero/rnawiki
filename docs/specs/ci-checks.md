...
| `data/revamp/ci-sample/thresholds-v11.json` + `presence-applicable-v11-hub-members.ndjson` | `scripts/revamp/ci_sample.py` | link graph |
...
from the render that ships with it. Measure 7 (v11) did that: the pair is `thresholds-v11.json` and
`presence-applicable-v11-hub-members.ndjson`, and the render sample is drawn from
`data/revamp/render-v11`.
...
#   --thresholds "$PWD/data/revamp/ci-sample/thresholds-v11.json" \
#   --presence "$PWD/data/revamp/ci-sample/presence-applicable-v11-hub-members.ndjson"
```
