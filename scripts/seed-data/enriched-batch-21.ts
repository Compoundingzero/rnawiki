...
export const ENRICHED_BATCH_21_DOSSIERS: SeedDossier[] = [
    ...
    substitutes: {
      ...
      homeRemedies: [
        ...
        },
        {
          ...
          patientImpact:
            'The label states that naproxen tablets and naproxen sodium tablets are not substitutes for low dose aspirin for cardiovascular protection. Naproxen inhibits platelet COX-1 reversibly and incompletely; aspirin does so covalently and permanently, which is why 81 mg once daily is enough.',
          clinicalPrecaution:
  ...
  // ---------------------------------------------------------------------------------------------
  {
    ...
    substitutes: {
      summary:
        'For most of the conditions paracetamol is recommended for, an NSAID is measurably more effective and measurably more dangerous, and the two together beat either alone. The choice is not simply about strength: paracetamol’s main serious risk is liver injury, while NSAIDs add gastrointestinal, kidney and platelet risks. In osteoarthritis specifically, the largest network meta-analysis concluded there is no role for single-agent paracetamol at any dose.',
      conventionalRx: [
        {
    ...
    commonQuestions: [
      ...
      },
      {
        ...
        a: 'A large Swedish cohort followed 2,480,797 children born between 1995 and 2019, of whom 7.49% were exposed in utero. In conventional analysis, exposure was associated with slightly higher risk of autism (hazard ratio 1.05), ADHD (1.07) and intellectual disability (1.05). The study then compared full siblings within the same family, which controls for shared factors including genetics and some reasons a mother needed the drug. In that comparison the hazard ratios were 0.98, 0.98 and 1.01, with no dose-response. The sibling comparison did not find increased risk of these outcomes, but it cannot establish complete safety. Paracetamol remains the recommended first-line option for pain and fever in pregnancy.',
        auditNote:
  ...
  // ---------------------------------------------------------------------------------------------
  {
    ...
    keyAudits: [
      ...
      },
      {
        ...
        technicalDetails:
          'Among the 19,114 ASPREE participants there were 1,052 deaths over a median 4.7 years. All-cause mortality was 12.7 events per 1,000 person-years on aspirin against 11.1 on placebo, hazard ratio 1.14 (95% CI 1.01 to 1.29). Cancer was the major contributor, accounting for 1.6 excess deaths per 1,000 person-years; cancer-related death occurred in 3.1% of the aspirin group against 2.3% of placebo, hazard ratio 1.31 (1.10 to 1.56). This runs directly against a substantial prior literature suggesting aspirin reduces cancer incidence and mortality, and the authors said so, writing that in the context of previous studies the result was unexpected and should be interpreted with caution. This was a secondary endpoint with post hoc cause-of-death exploration in a trial not designed for it, but it is also the largest randomised mortality dataset in healthy older adults. ASCEND, over a mean 7.4 years in 15,480 diabetic participants, found no difference in gastrointestinal tract cancer (2.0% against 2.0%) or in all cancers (11.6% against 11.5%).',
        evidenceSource:
      ...
      laboratoryWorkflow: [
        {
          ...
          description:
            'Indomethacin hydrolyses at the N-aroyl bond to 4-chlorobenzoic acid and 5-methoxy-2-methylindole-3-acetic acid, and it does so in aqueous suspension and at alkaline pH. The levels of those two specified degradants indicate how a suspension or compounded preparation has been handled.',
          reagentsAndBuffer:
  ...
  // ---------------------------------------------------------------------------------------------
  {
    ...
    substitutes: {
      summary:
        'Tramadol occupies a position — between an anti-inflammatory and a strong opioid — that the evidence does not support as a distinct category. In osteoarthritis its randomised benefit is smaller than an NSAID’s and its measured one-year mortality is higher; against codeine, an ordinary weak opioid, mortality is the same. Alternatives include an NSAID with its own well-characterised risks, a non-opioid drug with independent evidence in chronic pain, or an explicit decision that an opioid is warranted.',
      conventionalRx: [
        {
