    ...
    commonQuestions: [
      {
        ...
        auditNote:
          'The total-versus-free distinction is stated plainly on the label and is the commonest way phenytoin toxicity is missed.',
      },
      {
  ...
  // ---------------------------------------------------------------------------------------------
  {
    ...
    molecularSchema: {
      ...
      laboratoryWorkflow: [
        ...
        },
        {
          ...
          description:
            'Build the trisubstituted 1-phenyl-2-pyridinone core and install the pyridyl and cyanophenyl groups by cross-coupling. This is a genuinely more complex route than any other drug on these pages, which is one honest part of the reason the finished product costs what it does, though it is not the whole reason.',
    ...
    commonQuestions: [
      ...
      },
      {
        ...
        a: 'Two honest reasons and one absence. The synthesis is genuinely harder: perampanel is built by sequential palladium-catalysed couplings of three aromatic rings, where most drugs on these pages are made in one or two condensation steps. And it is the only AMPA receptor antagonist licensed anywhere, so for a person who has failed everything else there is nothing equivalent to switch to. The absence is evidence: no randomised trial has ever compared perampanel with lacosamide, brivaracetam, levetiracetam or any other anti-seizure drug. At United States pharmacy acquisition cost the median is US$17.50 per unit against about 17 cents for lacosamide and 11 cents for levetiracetam. Whether that gap corresponds to a difference in benefit is not a question the evidence base can answer.',
      },
      {
        q: 'Why is there no manufacturing cost on this page?',
