    ...
    commonQuestions: [
      {
        ...
        a: 'Live longer, and this is the specific molecule that proved it. In 4S, 4,444 people with existing coronary disease took simvastatin or placebo for a median of five and a half years: 8% of the simvastatin group died against 12% on placebo, a relative risk of 0.70 at p=0.0003. Crucially, non-cardiovascular deaths were almost identical between the groups — 46 against 49 — which laid to rest the long-standing worry that cholesterol drugs were trading heart deaths for other kinds. HPS then repeated the finding in 20,536 higher-risk adults with all-cause mortality 12.9% against 14.7%.',
        auditNote:
  ...
  // ---------------------------------------------------------------------------------------------
  {
    ...
    commonQuestions: [
      ...
      },
      {
        ...
        a: 'That pictures of arteries are not the same measurement as events, and the drug’s own label admits it. CCAIT found lovastatin significantly slowed lesion progression, with disease progression in 33% against 50% and new lesions in 16% against 32%. MARS, of similar design at a higher dose, missed its primary endpoint outright — average percent diameter stenosis rose 2.2% on placebo and 1.6% on lovastatin, p>0.20 — while its secondary global change score separated at p=0.002. The result is that MARS is quoted as a positive trial in review articles and reported as a negative one on the label, and both are honest descriptions of different numbers in the same paper. Imaging endpoints are cheaper, faster and smaller than outcome trials, and they are also less reliable — the same lesson arrived again a decade later when adding ezetimibe to simvastatin lowered LDL further and did not improve carotid wall thickness at all.',
      },
      {
  ...
  // ---------------------------------------------------------------------------------------------
  {
    ...
    commonQuestions: [
      ...
      },
      {
        ...
        a: 'Because interactions do not only happen at metabolism. Getting into the liver cell at all requires uptake transporters, and ciclosporin blocks them. The label states plainly that ciclosporin significantly increases pitavastatin exposure and increases the risk of myopathy and rhabdomyolysis, and makes the combination one of only three contraindications on the whole label. The same mechanism explains why erythromycin caps the dose at 1 mg daily and rifampin at 2 mg. So the drug escapes the cytochrome problem and inherits a transporter one, which is smaller but not zero.',
      },
    ],
    recentAuditDate: 'August 2026',
    hasDiscrepancy: true,
    ...
    substitutes: {
      ...
      homeRemedies: [
        ...
        },
        {
          ...
          action:
            'If a digoxin level is being checked, the timing of the last dose matters and is worth stating clearly.',
          patientImpact:
