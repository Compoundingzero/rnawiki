...
export const MRNA_DOSSIERS: SeedDossier[] = [
  ...
  // ---------------------------------------------------------------------------------------------
  {
    ...
    molecularSchema: {
      ...
      sequence5to3: '',
      laboratoryWorkflow: [
        {
          id: 'toz-1',
          stepNumber: 1,
    ...
    keyAudits: [
      ...
      },
      {
        ...
        evidenceSource: 'Mevorach et al., NEJM 2021, and the current COMIRNATY prescribing information',
    ...
    sources: [
      {
        label: 'Polack et al., Safety and Efficacy of the BNT162b2 mRNA Covid-19 Vaccine, NEJM 2020',
  ...
  // ---------------------------------------------------------------------------------------------
  {
    ...
    molecularSchema: {
      structureType: 'rna_sequence',
      sequence5to3: '',
      laboratoryWorkflow: [
        {
          id: 'ela-1',
          stepNumber: 1,
    ...
    sources: [
      {
        label:
          'Baden et al., Efficacy and Safety of the mRNA-1273 SARS-CoV-2 Vaccine, NEJM 2021',
  ...
  // ---------------------------------------------------------------------------------------------
  {
    ...
    keyAudits: [
      ...
      },
      {
        id: 'r45-a6',
        category: 'conclusion_shift',
        title: 'The licensed population widened after approval, on immunogenicity rather than efficacy',
        laymanSummary:
