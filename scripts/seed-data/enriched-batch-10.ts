...
export const ENRICHED_BATCH_10_DOSSIERS: SeedDossier[] = [
  ...
  // ---------------------------------------------------------------------------------------------
  {
    ...
    oneSentenceVerdict:
      'The first amide local anaesthetic: it blocks sodium channels from inside nerve cells, preventing them from firing. Its local-anaesthetic use was established before modern trial standards. In a 3,026-patient cardiac-arrest trial, intravenous lidocaine produced 23.7% survival to hospital discharge against 21.0% on saline, a difference of 2.6 percentage points that did not reach significance.',
    laymanHowItWorks:
  ...
  // ---------------------------------------------------------------------------------------------
  {
    ...
    commonQuestions: [
      ...
      },
      {
        ...
        a: 'It is the rescue treatment stocked wherever large regional blocks are done, but its evidence base is mechanistic rather than randomised. Bupivacaine is extremely lipid-soluble, so an intravenous bolus of lipid emulsion creates a compartment that pulls drug out of cardiac tissue — a lipid sink — and may also supply fatty acid substrate to a myocardium whose energy metabolism the drug has impaired. Animal experiments support it, and a large body of human case reports describes recoveries that were not expected. A randomised trial in people having a cardiac arrest from local anaesthetic does not exist and would not be ethically feasible, so the claimed benefit remains an inference rather than a randomised measurement.',
      },
      {
  ...
  // ---------------------------------------------------------------------------------------------
  {
    ...
    substitutes: {
      ...
      conventionalRx: [
        ...
        },
        {
          ...
          class: 'Intermediate-acting amide local anaesthetic',
          howItCompares:
            'Lidocaine is the shortest-acting of the three and had lower systemic cardiac toxicity in the comparisons described here. That difference matters when accidental intravascular dosing is the main concern, but it does not make one agent the safest choice for every procedure or patient.',
          typicalCost:
            'US$0.3221 per mL at United States pharmacy acquisition cost (CMS NADAC, median across 161 listed products, effective 19 August 2026)',
          prosAndCons:
            'Pros: faster unbinding from the cardiac channel and lower systemic cardiac toxicity than the longer-acting agents described here. Cons: about an hour of anaesthesia, not eight.',
        },
      ],
      naturalFoods: [],
      homeRemedies: [
    ...
    commonQuestions: [
      ...
      },
      {
        ...
        a: 'Because the CMS National Average Drug Acquisition Cost survey holds no value for ropivacaine on this record. The survey covers what United States retail pharmacies pay, and a drug used almost entirely inside hospitals and operating theatres may not appear in it. Rather than substitute a wholesale list price, an international figure or an estimate, this page leaves the field blank.',
      },
      {
        q: 'The epidural trial found less delirium. Is that a reason to have one?',
        a: "This was a large, randomised result. In 1,720 patients aged 60 to 90 having major thoracic or abdominal surgery, adding an epidural of ropivacaine to general anaesthesia reduced delirium in the first week from 5.0% to 1.8%, a relative risk of 0.351 and a number needed to treat of 31. The same trial found intraoperative systolic pressure below 80 mmHg in 49% of the epidural group against 33%, and more vasopressor use. The authors' own conclusion was to consider the combination in patients at risk of delirium and avoid it in patients at risk of hypotension. The trial does not establish whether the benefit belongs to ropivacaine specifically, to epidural analgesia generally, or to the reduced opioid exposure that came with it.",
      },
      {
  ...
  // ---------------------------------------------------------------------------------------------
  {
    ...
    commonQuestions: [
      ...
      },
      {
        ...
        a: 'That is the specific risk this class of drug creates, and it comes straight from the pharmacology. Rocuronium carries a permanent positive charge and cannot cross into the brain, so the label states that it has no known effect on consciousness, pain threshold or cerebration. It causes paralysis without providing anaesthesia or pain relief. In an unparalysed patient, inadequate anaesthesia may be apparent through movement, grimacing or breathing against the ventilator; a paralysed patient cannot show those signs. What remains is autonomic signs, which are confounded by every other drug in the anaesthetic, and processed EEG monitors, which are indirect. Neuromuscular blockade is therefore a known risk factor for accidental awareness under anaesthesia, and a previous episode is relevant before another operation.',
      },
      {
  ...
  // ---------------------------------------------------------------------------------------------
  {
    ...
    commonQuestions: [
      ...
      },
      {
        ...
        a: 'Because muscle that has lost its nerve supply, or has been immobilised, rebuilds its receptors. Normally the nicotinic receptors are packed into the endplate, a tiny fraction of the fibre surface, and they contain an epsilon subunit. After denervation or prolonged disuse, the muscle reverts to the fetal pattern: immature receptors containing a gamma subunit, spread across the entire fibre membrane, with channels that stay open longer. A depolarising agonist then opens vastly more channels, over a much larger area, for longer — and potassium pours out of every muscle in the body at once. The rise can be enough to stop the heart. The label contraindicates the drug after the acute phase of major burns, multiple trauma, extensive denervation and upper motor neuron injury, and states that the onset and duration of the risk period are undetermined.',
      },
      {
  ...
  // ---------------------------------------------------------------------------------------------
  {
    ...
    conditionContext: {
      ...
      clinicalGoals:
        'Calm, cooperative, amnesic, breathing. The sections below ask whether the drug improves outcomes beyond that. It does in status epilepticus but not in intensive care sedation, where it is now the comparator other drugs beat.',
    },
    oneSentenceVerdict:
  ...
  // ---------------------------------------------------------------------------------------------
  {
    ...
    keyAudits: [
      ...
      },
      {
        ...
        laymanSummary:
          'The label reports that after a single dose used to induce anaesthesia, cortisol and aldosterone fall, stay down for six to eight hours, and do not respond to the hormone that normally tells the adrenal gland to make more.',
        technicalDetails:
