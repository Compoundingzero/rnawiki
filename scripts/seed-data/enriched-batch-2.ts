    ...
    molecularSchema: {
      ...
      laboratoryWorkflow: [
        ...
        },
        {
          ...
          description:
            'Infect primary cells with wild-type virus and with K103N, Y181C, G190A and the double K103N/Y181C mutant, alongside V106A and F227C. This panel is the entire clinical claim for the molecule: it exists because those first four substitutions are common in people who have already been treated, and it has to fail against the last two to be honest about its own limits.',
