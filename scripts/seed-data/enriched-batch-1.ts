    ...
    molecularSchema: {
      ...
      laboratoryWorkflow: [
        ...
        },
        {
          ...
          description:
            'Purify chromatographically and confirm that the product falls inside the label’s stated distribution — average 5,000 daltons, about 90% between 2,000 and 9,000, with specified limits in each of three bands. Potency is expressed in anti-factor Xa international units rather than in milligrams, which is the honest unit for a material whose mass tells you nothing about how much of it works.',
    ...
    commonQuestions: [
      {
        ...
        a: 'At preventing clots, clearly. At keeping people alive, the trial found no difference. In TRITON-TIMI 38, 13,608 patients having stents placed, cardiovascular death, heart attack or stroke occurred in 9.9% on prasugrel against 12.1% on clopidogrel, and clots inside the stent were less than half as common, 1.1% against 2.4%. Against that, serious bleeding rose from 1.8% to 2.4%, and fatal bleeding from 0.1% to 0.4% — a fourfold increase in bleeding that kills. The trial’s own conclusion notes that overall mortality did not differ between the groups. For most people having a stent placed that is a good trade, because a stent thrombosis is usually catastrophic and most bleeds are not. For someone who bleeds easily, is small, is elderly, or has had a stroke, it stops being a good trade, and the label says so.',
        auditNote:
    ...
    commonQuestions: [
      {
        ...
        a: 'Its trial says yes and the trial is disputed, which is an unusual and honest place to leave it. PLATO randomised 18,624 patients with an acute coronary syndrome: cardiovascular death, heart attack or stroke occurred in 9.8% on ticagrelor against 11.7% on clopidogrel, and — the striking part — deaths from any cause fell from 5.9% to 4.5%. No other drug in this class has shown that. What sits beside it is written into the American label itself: the effect was smaller in North America and "numerically inferior to the control", the statistical test for the United States versus non-United States comparison was significant at p=0.009, and the same pattern appeared in both cardiovascular death and non-fatal heart attack. The label offers an explanation — higher aspirin doses in the United States — and immediately notes that this is an unplanned analysis of something investigators chose rather than something randomisation assigned.',
        auditNote:
  ...
  // ---------------------------------------------------------------------------------------------
  {
    ...
    commonQuestions: [
      ...
      },
      {
        ...
        auditNote:
          'Two futile trials and one positive one, whose benefit the regulator itself attributes to biomarker-defined events. That is the shape of the evidence, and the label states it more plainly than most summaries do.',
      },
      {
