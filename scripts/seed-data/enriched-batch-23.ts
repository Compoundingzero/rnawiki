...
export const ENRICHED_BATCH_23_DOSSIERS: SeedDossier[] = [
  ...
  // ---------------------------------------------------------------------------------------------
  {
    ...
    substitutes: {
      summary:
        'Buspirone’s position is defined by what it is not. Against a benzodiazepine it is slower, probably weaker and not habit-forming. Against an SSRI it has no antidepressant indication and no long-term data. The most honest comparison is that the Cochrane review found azapirones may be less effective than benzodiazepines and could not determine whether they beat antidepressants, kava or psychotherapy.',
      conventionalRx: [
        {
