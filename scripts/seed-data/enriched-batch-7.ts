...
export const ENRICHED_BATCH_7_DOSSIERS: SeedDossier[] = [
  ...
  // ---------------------------------------------------------------------------------------------
  {
    ...
    commonQuestions: [
      ...
      },
      {
        ...
        auditNote:
          'A drug that suppresses the surveillance test by half, and separately warns about the disease that test looks for, appears in two separate parts of the insert.',
      },
      {
        q: 'Why does this page not show a manufacturing cost?',
    ...
    molecularSchema: {
      ...
      laboratoryWorkflow: [
        ...
        },
        {
          ...
          description:
            'Measure radioligand displacement at each subtype for affinity, then blockade of phenylephrine-evoked calcium for functional antagonism, then inhibition of agonist-evoked contraction in the seminal tissue. Reporting the third result alongside the first two makes the selectivity claim complete: a high alpha-1A preference is simultaneously the efficacy result and the adverse-event result, and an assay panel that omits the seminal tissue reports only half of what the drug does.',
      ...
      homeRemedies: [
        {
          ...
          patientImpact:
            "In the 150-volunteer trial that established darifenacin's cognitive profile, oxybutynin ER produced memory impairment the authors described as comparable in magnitude to ten years of brain ageing — and there were no between-treatment differences in self-rated memory. The paper states that subjects were unaware of the deterioration.",
          clinicalPrecaution:
  ...
  // ---------------------------------------------------------------------------------------------
  {
    ...
    commonQuestions: [
      ...
      },
      {
        ...
        a: 'The published record does not provide a numerical effect size. The two pivotal trials enrolled 523 and 601 patients and both met their dual primary endpoints. Zinner and colleagues wrote that trospium "significantly decreased average frequency of toilet voids and urge incontinent episodes compared to placebo" and left it there. Staskin and colleagues wrote that treatment "resulted in significant improvements over placebo in all primary and key secondary efficacy outcomes at weeks 1 through 12" and left it there. Neither abstract contains a mean, a difference, a confidence interval or a p-value for efficacy. Both quantify adverse events to a decimal place. Other drugs in this class deliver between 0.12 and 0.6 fewer episodes a day than placebo, but the published abstracts do not allow that estimate to be checked for trospium.',
        auditNote:
  ...
  // ---------------------------------------------------------------------------------------------
  {
    ...
    conditionContext: {
      ...
      whyItMatters:
        'The randomised, placebo-controlled trials are positive, but the mechanism remains unknown. Candidate explanations include smooth muscle relaxation through the nitric oxide pathway, increased pelvic blood flow and reduced afferent nerve activity; the label commits to none of them.',
      whoTakesThis:
    ...
    commonQuestions: [
      {
        ...
        auditNote:
          'A licensed indication with randomised evidence and no agreed mechanism is unusual. The mechanism remains unresolved; presenting any candidate explanation as established would go beyond the label and the trials.',
      },
      {
        q: 'Is it better or worse than tamsulosin?',
        a: 'The trial that put them side by side could not answer that, and says so. Oelke and colleagues randomised 511 men to placebo, tadalafil or tamsulosin. Against placebo, symptom scores improved 2.1 points on tadalafil and 1.5 on tamsulosin; peak flow rose 2.4 and 2.2 millilitres a second. Both beat placebo; the trial\'s own limitations section states it "was limited in not being powered to directly compare tadalafil versus tamsulosin." The evidence supports two separate positive placebo comparisons, not a demonstrated tie or a demonstrated win. Where the two drugs did separate unambiguously was erectile function: 4.0 points of improvement on tadalafil against -0.4 on tamsulosin. Quality-of-life and treatment-satisfaction scores also improved with tadalafil and not with tamsulosin, which most plausibly follows from that.',
      },
      {
