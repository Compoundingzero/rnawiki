 ...
 *    An unverified cost is worse than an absent one. It is also worth saying plainly that for an
 *    inhaler the molecule is close to free and the device is not.
 *
...
export const ENRICHED_BATCH_24_DOSSIERS: SeedDossier[] = [
  ...
  // ---------------------------------------------------------------------------------------------
  {
    ...
    pricing: {
      ...
      markupEstimate: '',
      openPatentNotes:
        'The price is the whole story of this drug and it has now reversed. At launch, levalbuterol nebuliser solution cost as much as five times racemic albuterol depending on purchase method — the subject of a 2000 Pharmacotherapy analysis titled, plainly, "Levalbuterol nebulizer solution: is it worth five times the cost of albuterol?" In 2026, at pharmacy acquisition cost, levalbuterol is US$0.2676 per millilitre and racemic albuterol is US$0.2505: a difference of about seven per cent. The clinical evidence never changed. The patent expired.',
      synthesisComplexity: 'Moderate',
      costSource: COST_OF_PRODUCTION_SOURCE,
      priceSource: NADAC_SOURCE,
    },
    ...
    commonQuestions: [
      ...
      },
      {
        ...
        a: 'That is a conversation to have with whoever prescribes it, and the honest summary is that these are the same pharmacology at the same receptor and either is a reasonable rescue treatment. The reason the question used to matter was money: levalbuterol once cost up to five times racemic albuterol, and a 2000 analysis asked in its title whether it was worth that. At United States pharmacy acquisition cost in August 2026 the gap is about seven per cent — US$0.2676 against US$0.2505 per millilitre of nebuliser solution — so for most people the practical answer is that it no longer makes much difference either way.',
      },
      {
  ...
  // ---------------------------------------------------------------------------------------------
  {
    ...
    substitutes: {
      summary:
        'For itch and hives, the substitute is its own metabolite: a head-to-head trial found cetirizine 10 mg once daily equivalent to hydroxyzine 25 mg three times daily, with four sedation withdrawals on hydroxyzine against one on cetirizine. For anxiety, the honest comparison is with the treatments that have durable evidence — cognitive behavioural therapy and the antidepressants — because hydroxyzine’s own label states that its effectiveness beyond four months has never been assessed. The reason it keeps being chosen is that it is not a controlled substance, and that is a property of drug law rather than of pharmacology.',
      conventionalRx: [
        {
          name: 'Cetirizine (Zyrtec)',
    ...
    commonQuestions: [
      ...
      },
      {
        ...
        a: 'The label answers this directly and unusually honestly: the effectiveness of hydroxyzine as an antianxiety agent for long-term use, that is more than 4 months, has not been assessed by systematic clinical studies, and the physician should periodically reassess whether it is still useful for the individual patient. That is not a statement that it stops working. It is a statement that nobody has looked. Given that the reason it tends to be chosen is a comparison with benzodiazepines about long-term harm, the absence of any long-term benefit data is the gap worth knowing about.',
      },
      {
  ...
  // ---------------------------------------------------------------------------------------------
  {
    ...
    conditionContext: {
      ...
      clinicalGoals:
        'Fewer exacerbations and better lung function, with the liver watched. The label states plainly that it is not for an acute attack.',
    },
    oneSentenceVerdict:
  ...
  // ---------------------------------------------------------------------------------------------
  {
    ...
    substitutes: {
      summary:
        'For the antidote use there is no substitute and no need for one. For the mucolytic use the honest position is that the alternatives are better evidenced than acetylcysteine is: nebulised hypertonic saline has a 164-patient randomised trial in cystic fibrosis with a mixed but real result, and dornase alfa attacks the other polymer in purulent mucus — DNA from dead cells — which acetylcysteine explicitly does not touch, since its own label states the mucolytic activity is unaltered by the presence of DNA. Guaifenesin is cheaper than all of them and thinner on evidence than any.',
      conventionalRx: [
        {
