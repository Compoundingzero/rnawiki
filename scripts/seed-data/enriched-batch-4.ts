    ...
    keyAudits: [
      {
        ...
        technicalDetails:
          'Sankar and colleagues systematically reviewed the burden of late vitamin K deficiency bleeding and the effect of prophylaxis. The median burden without prophylaxis was 35 per 100,000 live births (interquartile range 10.5 to 80), rising to 80 per 100,000 in low- and middle-income countries against 8.8 per 100,000 in high-income countries. Two randomised trials evaluated intramuscular prophylaxis, but only against classical vitamin K deficiency bleeding: one found a reduction in any bleeding (RR 0.73, 95% CI 0.56 to 0.96) and in moderate-to-severe bleeding (RR 0.19, 95% CI 0.08 to 0.46, number needed to treat 74), and the other a reduction in secondary bleeding after circumcision (RR 0.18, 95% CI 0.08 to 0.42, NNT 9). The reviewers state that no randomised trial has evaluated the effect of vitamin K prophylaxis on late vitamin K deficiency bleeding, which is the outcome the whole practice exists to prevent. The estimate for that outcome comes from four surveillance studies pooled: relative risk 0.02 (95% CI 0.00 to 0.10). They grade the evidence as low quality from observational studies, and still recommend universal intramuscular prophylaxis, because the outcome being prevented is intracranial haemorrhage in a healthy infant.',
        evidenceSource:
  ...
  // ---------------------------------------------------------------------------------------------
  {
    ...
    mechanismSteps: [
      ...
      },
      {
        ...
        molecularDetail:
          'The label states that reversing dabigatran exposes patients to the thrombotic risk of their underlying disease and directs that anticoagulation be resumed as soon as medically appropriate. Thirty-three of 503 patients in RE-VERSE AD had a thrombotic event, most of them not back on antithrombotic therapy at the time.',
        iconName: 'AlertTriangle',
        visualStage: 'therapeutic_result',
      },
      {
    ...
    commonQuestions: [
      ...
      },
      {
        ...
        a: 'Because the trial enrolled people who were already in serious trouble: nearly a third of the bleeding group had bled into the brain and nearly half had major gastrointestinal bleeding. Reversing the anticoagulant removes one contributor to a catastrophe that has usually already happened. The evidence shows that the laboratory value was corrected, but it cannot show what the death rate would have been without the antidote because nobody was randomised to go without it.',
        auditNote:
  ...
  // ---------------------------------------------------------------------------------------------
  {
    ...
    commonQuestions: [
      ...
      },
      {
        ...
        auditNote:
          'The authors describe the finding as unexpected and contrary to previous studies, which is the clearest way to report it.',
      },
      {
